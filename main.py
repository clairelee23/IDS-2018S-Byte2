...
API_KEY = 'AIzaSyBLShNPVuj-XXawsnod2b5rinMtvRX_12M'
...
TABLE_ID = '1PJk4W3-pxrWO_lh45mJ7QC65gFuVLS2K_vmHVS0p'
...
def index():
    ...
    # Key code
    res = get_all_data(make_query([], 20)) #20 is our limit we're passing in
...
def update_table():
    ...
    logging.info(cols)
    result = get_all_data(make_query(cols, 20)) #20 is our limit we're passing in
    logging.info(result)
